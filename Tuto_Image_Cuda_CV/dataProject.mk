...
TARGET_NAME:=Tuto_Image_CV_Cuda
...
include $(API_CBI_TOOLS)/bilat_tools_cuda_image_cv.mk
include $(API_CBI_TOOLS)/bilat_tools_cuda.mk

#include $(API_CBI_IMAGE_CUDA)/bilat_image_freeglut_cuda.mk
#include $(API_EXT)/opencv.mk
