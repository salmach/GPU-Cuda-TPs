...
TARGET_NAME:=Student_Cuda_Image
...
include $(API_CBI_TOOLS)/bilat_tools_cuda_image.mk
include $(API_CBI_TOOLS)/bilat_tools_cuda.mk
include $(API_CBI_TOOLS)/bilat_tools_cpp.mk
include $(API_CBI_TOOLS)/bilat_tools_opencv.mk
...
override SRC_AUX+= ../Student_Cuda_Image/src/cpp/core/Rippling
override SRC_AUX+= ../Student_Cuda_Image/src/cpp/core/RayTracing 
#################################################
#						End/	 			 		#
#################################################
